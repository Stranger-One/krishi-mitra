...
export function Footer() {
  ...
  const navT = useTranslations("landing.navigation")
  ...
  return (
    <footer className="bg-card border-t">
      <div className="container mx-auto px-4 sm:px-10 lg:px-20 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Services */}
          <div className="space-y-4">
            <h3 className="font-semibold text-lg">{navT("services")}</h3>
            <nav className="flex flex-col space-y-2 text-base text-muted-foreground">
